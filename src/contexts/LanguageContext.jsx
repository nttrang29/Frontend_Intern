...
const translations = {
  vi: {
    ...
    "budgets.status.all": "Tất cả",
    "budgets.status.active": "Đang hoạt động",
    "budgets.status.pending": "Đang chờ",
    "budgets.status.completed": "Hoàn thành",
    "budgets.status.warning": "Vượt ngưỡng",
    ...
    "budgets.side.related_title": "Giao dịch liên quan",
  ...
  en: {
    ...
    "budgets.status.all": "All",
    "budgets.status.active": "Active",
    "budgets.status.pending": "Pending",
    "budgets.status.completed": "Completed",
    "budgets.status.warning": "Warning",
    "budgets.status.over": "Exceeded",
    ...
    "budgets.side.related_title": "Related Transactions",
